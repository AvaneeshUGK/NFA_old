		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "nfa_arb",
									"targetURL": "#nfaarbnfaarb-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nfaarbnfaarb-display": {
								"semanticObject": "nfaarbnfaarb",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nfaarb.nfaarb",
									"url": sap.ui.require.toUrl("nfaarb/nfaarb")
								}
							}
						}
					}
